...
monster_elite_tank::monster_elite_tank(math::vec2 const p, float const z, engine::actor& tgt, geometry::map_data& map, engine::world& wrld)
	: monster(p, z, 6, 1.0f, 400.0f, 150.0f, 60.0f, 50.0f, 200.0f, 15.0f, 1.2f, tgt, map, wrld),
