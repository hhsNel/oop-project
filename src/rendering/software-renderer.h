...
namespace rendering {
    class software_renderer {
		...
		void add_visplane(int x, int y_start, int y_end, float flat_height, assets::asset_pack::texture_id tex_id, std::uint8_t const sector_light_level, frame_rendering_data const frd);
