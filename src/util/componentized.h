...
template<fixed_string field>
consteval component_tag<field> operator""_f() {
	return {};
}
...
/* usage:
 * class test : public componentized<test> {
 *	 [[=component_field{}]] int hp;
 *	 [[=component_field{}]] int max_hp;
 * 
 *	 float secret;
 * 
 *	 [[=component_field{}]] float speed;
 * 
