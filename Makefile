SRCDIR = src
MODULES = math geometry assets engine combat combat/weapons rendering util input input/evdev rendering/drm-kms entities entities/monsters world_objects systems audio audio/alsa game
BUILDDIR = build
RESDIR = res
TESTDIR = tests
